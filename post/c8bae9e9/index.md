...
![image-20230727230958332](https://s1.vika.cn/space/2023/07/27/18a69aa66a864e12a812bd15d11549f0)
...
![image-20230727231522414](https://s1.vika.cn/space/2023/07/27/c8d5093b63064626b376caf7e8149502)

### 本地普通管理员权限

本地一般管理员就是加入了administrators组的管理员但不是administrator用户(job)

![image-20230727232251428](https://s1.vika.cn/space/2023/07/27/141a7c13d9ed4ea988f29c05030bc029)

下面演示一下，最高管理员与普通管理员的区别(添加新用户)

![image-20230727232556195](https://s1.vika.cn/space/2023/07/27/c7d2640bc64c46ec9ecc0e54cc976043)

切换用户到普通管理员job

![image-20230727232829755](https://s1.vika.cn/space/2023/07/27/4d37ed431e2346ba9b96620f60ae90b4)

发生系统错误拒绝访问，有些操作执行不了，因为有UAC的存在，执行高权限的操作必须右键使用管理员打开

![123](https://s1.vika.cn/space/2023/07/27/cd559762f8c64e9ebaeb25078044b170)

### 本地普通用户

本地普通用户，就是在windows电脑中本地新建的普通用户。没有管理员的权限，一般很多操作搜执行不了，需要管理员认证才可以指向，以下是windows用户组，新建的用户一般是默认是user组

![image-20230727233717623](https://s1.vika.cn/space/2023/07/27/bbe13500c8024c459acbbf24298dea37)

当进行高权限的操作时候会出现以下认证(需要输入管理员的账号和密码才可以)

![image-20230727233839810](https://s1.vika.cn/space/2023/07/27/902ab0528d7249ad8b189183eaf537c3)
...
![image-20230727235059498](https://s1.vika.cn/space/2023/07/27/9575d66f06e3448d8cb745609a83d6eb)

凭据提示当标准用户(普通用户)尝试执行需要用户管理访问令牌的任务时，会显示凭据提示。
还可以要求管理员提供其凭据
...
UAC设置分为四种，分为始终通知、仅在成俗尝试对我计算机进行更改时通知我、仅当承租尝试更改计算机时通知我(不降低桌面亮度)和从不通知。输入Win+R-->msconfig设置UAC(`要用管理员账号来设置`)

![image-20230728000139921](https://s1.vika.cn/space/2023/07/27/7d91217d7b69430b83618499ddb48dca)

![image-20230728000200714](https://s1.vika.cn/space/2023/07/27/f3a5c4671050406ababd52c0424f2fcd)

`默认都为第二档位`

![image-20230728000230250](https://s1.vika.cn/space/2023/07/27/c1862677e9244cc7b52ef8011d51e764)

我们将它设置为从不通知，我们切换账号到普通管理员(job),再次使用管理员身份打开，许可提示消失

![关闭提示](https://s1.vika.cn/space/2023/07/27/58817713dff34ca09cf95780ead49df6)

再次切换用户到普通用户xun，发现依然需要提供凭证

![66](https://s1.vika.cn/space/2023/07/27/f67de178b798498494b0ed110306439b)
...
![image-20230728002737459](https://s1.vika.cn/space/2023/07/27/342174fd5669428ebaaf999ea837d47a)
...
![image-20230728094222190](https://s1.vika.cn/space/2023/07/28/4608fca21c684717b14028cc711648b4)
...
![image-20230728095908967](https://s1.vika.cn/space/2023/07/28/0a29433866bb46cab634fdc689634221)
...
![image-20230728100518821](https://s1.vika.cn/space/2023/07/28/c2d5296c1ec74f519f7e9958ea0b1bd0)

domain Admins中默认会有一个Administrator用户

![image-20230728100801855](https://s1.vika.cn/space/2023/07/28/5a49439700994cadb3937647d1ee0332)
...
![image-20230728101955190](https://s1.vika.cn/space/2023/07/28/7c8343a8bd7241ec9d2411b12a5c4745)
...
![image-20230728103608344](https://s1.vika.cn/space/2023/07/28/34ef51d0c7684af9aea92bd71b3ce672)

这里可以看到我们添加的liu用户也默认在该组中，在域控默认添加用户都在Domain users组

Domain Users组，该组在域内机器中存在Users组，这样用户可以当作普通用户登录域内主机

![image-20230728103814226](https://s1.vika.cn/space/2023/07/28/1cb93550b28842b4814a211d903cfa4b)

Domain Computers组，任何由我们建立的计算机账号都属于该组

![image-20230728104024949](https://s1.vika.cn/space/2023/07/28/f5d6483b1fd94282bdcbfe479cf6dcc7)
...
![image-20230728182216624](https://s1.vika.cn/space/2023/07/28/4d2be6c6cb774bcca6db51e98475c325)
...
![image-20230728183157327](https://s1.vika.cn/space/2023/07/28/eba11c28a3e24be5941a371ee5dbe48b)
...
![image-20230728185712554](https://s1.vika.cn/space/2023/07/28/9f85565b9ad24f6398857c671baec137)
...
![666](https://s1.vika.cn/space/2023/07/28/1d685537b6c046c695c1bc58331a3c6d)

使用system的令牌 incognito.exe execute -c "NT AUTHORITY\SYSTEM" cmd

![image-20230728190832484](https://s1.vika.cn/space/2023/07/28/17f906c14eaa466bb7b385734cecd305)

whoami可以看到现在是system权限，现在我们再去查询域内用户

![image-20230728191022938](https://s1.vika.cn/space/2023/07/28/b418a86fef5445f2a5ebf9c1174e60b3)
